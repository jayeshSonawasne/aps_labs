    ...
    <div className="container-fluid">
      <div className="row justify-content-around py-5">
        ...
        <div className="col-md-4">
          <img src="/Images/contactimage.png" alt="..." width="90%" />
        </div>
      </div>
        ...
        <div className="col-md-5 mt-4">
          <div className="row justify-content-center">
            <div className="col-md-2 text-center">
              <span style={{ fontSize: "35px", color: "#3498DB" }}>
                <FiSend />
              </span>
            </div>
            <div className="col-md-10">
              Row House-27/B, SR no-241/2B, Jayprakash Nagar, Airport
              Rd,Lohegaon,PUNE-411032, Maharashtra, India
            </div>
          </div>
          <div className="row justify-content-center mt-3">
            ...
            <div className="col-md-10">info@apslabs.in</div>
          </div>
          <div className="row justify-content-center mt-3">
            <div className="col-md-2 text-center">
              <span style={{ fontSize: "35px", color: "#3498DB" }}>
            ...
            <div className="col-md-10">020-26686683</div>
          </div>
          <div className="row justify-content-around mt-3">
            <h4>Global Presence</h4>
            <svg width="400" height="200">
              <g transform="scale(0.36363636363636365) translate(75.00000000000001, 0)">
                <path
      ...
      <div className="row mt-5">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3781.2450114201038!2d73.935226414046!3d18.608046371351627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c12d08b1ba5f%3A0x2d103689b297e123!2sAPS%20LABS!5e0!3m2!1sen!2sin!4v1668593229447!5m2!1sen!2sin"
          width="600"
          height="300"
          allowfullscreen=""
          loading="lazy"
